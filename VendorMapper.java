...
public class VendorMapper implements ResultSetMapper<Vendor> {
  ...
  public final Vendor map(final int idx, final ResultSet rs, final StatementContext ctx) throws SQLException {
    ...
    return new Vendor(rs.getInt("VENDOR_ID"),rs.getString("VENDOR_NAME"),rs.getString("VENDOR_EMAIL"),rs.getLong("VENDOR_MOBILE"),rs.getString("VENDOR_ADDRESS"),rs.getString("VENDOR_PASSWORD"));
  }
}
